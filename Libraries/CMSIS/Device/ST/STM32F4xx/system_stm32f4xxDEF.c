...
/* PLL_VCO = (HSE_VALUE or HSI_VALUE / PLL_M) * PLL_N */
  /* TODO PLL_M = 8 for discovery board */
/* #define PLL_M      25 */
#define PLL_M      8
#else /* STM32F411xE */
#if defined (USE_HSE_BYPASS)
...
#if defined (STM32F40_41xxx)
  uint32_t SystemCoreClock  __attribute__((weak)) = 168000000;
#endif /* STM32F40_41xxx */

#if defined (STM32F427_437xx) || defined (STM32F429_439xx)
  uint32_t SystemCoreClock  __attribute__((weak)) = 180000000;
#endif /* STM32F427_437x || STM32F429_439xx */

#if defined (STM32F401xx)
  uint32_t SystemCoreClock  __attribute__((weak)) = 84000000;
#endif /* STM32F401xx */

#if defined (STM32F411xE)
  uint32_t SystemCoreClock  __attribute__((weak)) = 100000000;
#endif /* STM32F401xx */

__I uint8_t AHBPrescTable[16]  __attribute__((weak)) = {0, 0, 0, 0, 0, 0, 0, 0, 1, 2, 3, 4, 6, 7, 8, 9};
